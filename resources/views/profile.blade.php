        ...
        <div class="container">
            <div class="row d-flex align-items-center">
                ...
                <div class="col-md-6 pl-md-5 ftco-animate py-5">
                    ...
                    <p style="color: #666;">Didirikan pada tahun <strong>2014</strong>, PT Triglobalindo Berkat Utama
                        (TBU) bermula dari sebuah visi sederhana untuk menyediakan layanan konstruksi yang mengutamakan
                        integritas dan kualitas.</p>
                    <p style="color: #666;">Berawal dari proyek-proyek fabrikasi skala kecil, kami terus berkembang dan
                        mendapat kepercayaan dari berbagai mitra klien. Seiring berjalannya waktu, TBU melebarkan
                        sayapnya menjadi General Contractor yang menangani proyek sipil, mekanikal, dan elektrikal.</p>
                    <p style="color: #666;">Kini, dengan dukungan tenaga ahli profesional dan manajemen yang solid, PT
                        Triglobalindo Berkat Utama telah menjadi mitra strategis bagi berbagai perusahaan swasta dan
                        instansi pemerintah di Indonesia, khususnya di wilayah Jawa Barat dan Jabodetabek.</p>
                </div>
            </div>
        </div>
    </section>
