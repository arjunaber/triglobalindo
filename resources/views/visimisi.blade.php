...
<head>
    ...
    <style>
        ...
        /* --- NAVBAR STYLE (SAMA DENGAN PAGE LAIN) --- */
        #ftco-navbar {
        ...
        /* --- CSS KHUSUS HALAMAN VISION MISSION --- */
        .hero-wrap-2 {
            height: 500px;
            position: relative;
        ...
        /* Pattern background halus (opsional) */
...
<body>
        ...
        <div class="container">
            <div class="row no-gutters slider-text align-items-end justify-content-start">
                <div class="col-md-9 ftco-animate">
                    ...
                    <h1 class="mb-0 bread" style="font-weight: 700; color: #fff;">Visi & Misi</h1>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="vision-section text-center"
        style="background-image: url('{{ asset('images/gambar_kerja.jpg') }}'); background-size: cover; background-position: center; position: relative; padding: 6rem 0;">

        <div class="overlay"
            style="position: absolute; top: 0; left: 0; right: 0; bottom: 0; background: rgba(21, 62, 128, 0.85); z-index: 1;">
        </div>
            ...
            <div class="row justify-content-center ftco-animate">
                <div class="col-md-10">
                    <span class="subheading"
                        style="color: var(--brand-light-blue); text-transform: uppercase; letter-spacing: 2px; font-weight: 600;">Visi
                        Perusahaan</span>
                    <h2 class="mb-4 text-white" style="font-weight: 700;">Our Vision</h2>

                    <div class="vision-quote-icon">
                        <i class="fas fa-quote-left"></i>
                    </div>

                    <p class="vision-text">
                        "Menjadi perusahaan kontraktor terkemuka yang terpercaya, profesional, dan inovatif dalam
                        memberikan solusi konstruksi serta pengadaan terbaik yang berkontribusi pada pembangunan
    ...
    <section class="ftco-section bg-light">
        <div class="container">
            <div class="row d-flex align-items-center">
                <div class="col-md-6 mb-4 mb-md-0 ftco-animate">
                    <div class="img w-100"
                        style="background-image: url('{{ asset('images/Service_GC.png') }}'); border-radius: 12px; min-height: 500px; box-shadow: 20px 20px 0px rgba(21, 62, 128, 0.1);">
                    </div>
                </div>

                <div class="col-md-6 pl-md-5 ftco-animate">
                    <div class="heading-section mb-5">
                        <span class="subheading" style="color: var(--brand-blue);">Misi Kami</span>
                        <h2 class="mb-4" style="color: var(--brand-dark-blue);">Our Mission</h2>
                        <p style="color: #666;">Untuk mewujudkan visi tersebut, PT Triglobalindo Berkat Utama
                            berkomitmen melaksanakan langkah-langkah strategis berikut:</p>
                    </div>

                    <div class="mission-box">
                        <ul class="mission-list">
                            <li>
                                <strong>Kualitas & Kepuasan Pelanggan</strong><br>
                                Memberikan hasil pekerjaan konstruksi dan produk fabrikasi dengan standar mutu tertinggi
                                untuk menjamin kepuasan klien.
                            </li>
                            <li>
                                <strong>Keselamatan Kerja (K3)</strong><br>
                                Menerapkan standar Kesehatan dan Keselamatan Kerja yang ketat dalam setiap lingkungan
                                proyek untuk melindungi seluruh tenaga kerja dan aset.
                            </li>
                            <li>
                                <strong>Integritas & Profesionalisme</strong><br>
                                Menjalankan bisnis dengan prinsip kejujuran, transparansi, dan tanggung jawab penuh
                                terhadap setiap kontrak kerja.
                            </li>
                            <li>
                                <strong>Pengembangan Berkelanjutan</strong><br>
                                Terus berinovasi dalam metode kerja dan teknologi, serta meningkatkan kompetensi sumber
                                daya manusia (SDM) perusahaan.
                            </li>
                            <li>
                                <strong>Kemitraan Jangka Panjang</strong><br>
                                Membangun hubungan kerjasama yang sinergis dan saling menguntungkan dengan klien, mitra
                                bisnis, dan supplier.
                            </li>
                        </ul>
                    </div>
